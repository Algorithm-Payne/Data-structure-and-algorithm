...
> ~~~
>
> 问题规模是矩阵的阶n,算法的控制结构式三重循环，基本操作是乘法操作
>
...
>    > 布隆过滤器去重（源于哈希算法）
>
> 3. 时空转换：将**昂贵的**时间转化为**廉价的**空间
>
>    > 当‘优无可优时’,取贵舍廉
>    >
>    > 空间是可以用**钱**买的，加个什么**内存**啊，加个**处理器**等等什么的
>    >
>    > 时间是逝去就不在了
>
...
![电脑类型](D:\Note\数据结构与算法\DataStructure\电脑类型.png)
